...
export class ContentAuthorizationComponent implements OnInit{
    ...
    public submission_id = 9;
    public sub;
    public submission_level = 1;
    ...
    // public isFieldValid1(field: string) {
    //     return !this.searchForm.get(field).valid && this.searchForm.get(field).touched;
    // }

    // public displayFieldCss1(field: string) {
    //     return {
    //         'is-invalid': this.isFieldValid1(field),
    //         'is-valid': this.isFieldValid1(field)
    //     };
    // }
