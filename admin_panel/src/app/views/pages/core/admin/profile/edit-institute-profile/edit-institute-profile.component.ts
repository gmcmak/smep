...
@Component({
    selector: 'edit-institute-profile',
    templateUrl: 'edit-institute-profile.component.html',
    styleUrls: ['edit-institute-profile.component.css']
})

export class EditInstituteProfileComponent{
