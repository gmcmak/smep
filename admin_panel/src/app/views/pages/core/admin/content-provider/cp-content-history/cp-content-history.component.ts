...
@Component({
    selector: 'cp-content-history',
    templateUrl: 'cp-content-history.component.html',
    styleUrls: ['cp-content-history.component.css']
})

export class CpContentHistoryComponent implements OnInit{
