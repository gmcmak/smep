...
export const routes: Routes = [
  ...
  { path: 'users/update-users/:id', component: UpdateUsersComponent },
  ...
  { path: 'institute/update-institute/:id', component: UpdateInstituteComponent },
  ...
  { path: 'content-consumer/update-consumers/:id', component: UpdateConsumersComponent },
  ...
  { path: 'settings/author/update-author/:id', component: UpdateAuthorComponent },
  ...
  { path: 'settings/role/update-role/:id', component: UpdateRoleComponent },
  ...
  { path: 'settings/module/update-module/:id', component: UpdateModuleComponent },
